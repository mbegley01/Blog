...
Of all the categories, this is the one I am still the most stuck on. One consideration I had is that space itself is a physical object, so locations can only exist in comparison. It is not possible to have just one locaiton unless that location is trivially the entire object, otherwise it would be in relation to another part of the object. 

On the other hand, is space not a physical object but an abstract concept that holds the potential for distance? Kind of like a set of rules determining what objects can be where? From this view, it seems like we would be allowed to take a more substantavalist view because even in the absence of objects within a space, there is existence of structure. 
